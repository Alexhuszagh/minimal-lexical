...
#[inline]
pub fn scientific_exponent(exponent: i32, integer_digits: usize, fraction_start: usize) -> i32 {
    if integer_digits == 0 {
...
#[inline]
pub fn mantissa_exponent(exponent: i32, fraction_digits: usize, truncated: usize) -> i32 {
