...
impl ExtendedFloat {
    ...
    #[inline]
    pub fn round_to_native<F, Algorithm>(&mut self, algorithm: Algorithm)
    where
        F: Float,
    ...
    #[inline]
    pub fn into_downward_float<F: Float>(mut self) -> F {
...
#[inline]
pub fn from_float<F>(f: F) -> ExtendedFloat
where
    F: Float,
{
    ExtendedFloat {
...
#[inline]
pub fn into_float<F>(fp: ExtendedFloat) -> F
where
    F: Float,
{
